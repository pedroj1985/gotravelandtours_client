                ...
                <div class="map-wrapper">
                        ...
                        <ul id="icon-list-ul">
                            <li>
                                <div class="item-info-icon-people">
                                    ...
                                    <div class="iii-info-item iii-info-text">{{car.CantidadPlazas}}</div>
                                </div>
                            </li>
                            <li>
                                <div class="item-info-icon-transmission">
                                    <div class="iii-info-item iii-info-icon"><i class="mdi mdi-engine"></i></div>
                                    <div class="iii-info-item iii-info-text">{{displayTransmission($helpers.traducir($helpers.findTransmissionLocale(car.TipoTransmision)))}}</div>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="left-side-map">
                        ...
                        <div class="custom-line-2">
                            <a href="#disponibilidad_precio" class="gtt-button">Disponibilidad y precio</a>
                            <a href="#politicas_info" class="gtt-button">Políticas e información</a>
                        </div>
                    </div>
                        ...
                        <div class="right-side-bar">
                            ...
                            <div class="row icons-row">
                                <div class="col-lg-6">
                                    <div class="item-info-icon-people gtt-text-color">
                                        <div class="iii-info-item iii-info-icon font36"><i class="mdi mdi-account"></i></div>
                                        <div class="iii-info-item iii-info-text">{{car.CantidadPlazas}}</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="item-info-icon-transmission gtt-text-color">
                                        <div class="iii-info-item iii-info-icon font36"><i class="mdi mdi-engine"></i></div>
                                        <div class="iii-info-item iii-info-text">{{displayTransmission($helpers.traducir($helpers.findTransmissionLocale(car.TipoTransmision)))}}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="attention-note general-text-opt">
                                ...
                                <div class="attention-text">
                                    Chequee su auto antes de partir. Notifique al personal de renta si detecta cualquier desperfecto y exija que se anote en el contrato
                                </div>
                            </div>
                        </div>
                    </div>
