  ...
  <div id="my-reservations">
    <div id="r-filters" class="br-10">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="filter-wrapper">
            ...
            <div class="filter-input">
              <input type="text" placeholder="Nombre de la orden" v-model="filtroNombreOrden">
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="filter-wrapper">
            ...
            <div class="filter-input">
              <input type="text" placeholder="Número de orden" v-model="filtroNumeroOrden">
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          ...
          <div class="filter-wrapper">
            ...
            <div class="filter-input">
              <v-date-picker
                  ...
                  mode='single'
                  locale="es"
                  :input-props='{placeholder: "Fecha de Inicio", readonly: true }'
              />
            </div>
          </div>
        </div>
          ...
          <div class="filter-wrapper">
            ...
            <div class="filter-input">
              <v-date-picker
                  ...
                  mode="single"
                  locale="es"
                  :input-props='{placeholder: "Fecha de cierre", readonly: true }'
              />
            </div>
          </div>
        </div>
      ...
      <div class="form-actions flex-wrapper" id="rfa">
          <button @click="search" type="submit" class="antonio-regular ml-auto">Buscar</button>
      </div>
    </div>
    <div id="r-results">
...
<script>
import {authGetOrders,
        authGetOrdersCount} from '../../utils/auth'
...
export default {
    ...
    methods: {
      ...
      rowClass(item, type) {
          ...
          // if (item.estado === 'Open') return 'table-info'
        } 
    },
    data(){
      return {
